...
function App() {
  ...
  // nende suhted üksteisega. See võib olla kasulik, kui
  ...
  // kuvab need hierarihiselt, näidates iga elemendi lapsi ja vanemaid.
  // See on kasulik, kui soobite näha, kuidas elemendid on omavahel seotud
  // ja kuidas nad on paidutatud lehel. See võib aidata teil mõista,
  ...
  // Nüüd proovime muuta dokumendi taustavärvi, mis on DOM-i element.
  //document.body.style.backgroundColor = "lightblue"

  // Nüüd muudame h1 all olevat teksti, mis on DOM-i element. See on
  // nagu veebilehe peamine pealkiri, mis kubatakse lehe sisu sees.
    ...
    <>
      <section id="dom-Title">
        ...
        <p>
          ...
          siis see loob DOM-i elemendid ja renderdab need #rood div-i sisse,
